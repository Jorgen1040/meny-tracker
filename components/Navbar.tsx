                    ...
                    <div className="relative flex items-center justify-between">
                        ...
                        <form method="GET" className="">
                            <div className="relative text-gray-600 focus-within:text-gray-400 flex-grow">
                                ...
                                <input type="search" name="q" className="py-2 text-sm text-white bg-red-400 rounded-md pl-10 focus:outline-none focus:bg-gray-100 focus:text-gray-900" placeholder="Søk..." autoComplete="off" />
                            </div>
                        </form>
